...
type blockData struct {
	...
	headerResult *btcjson.GetBlockHeaderVerboseResult
}
...
func (p *BlockPrefetchClient) GetBlockData(hash *chainhash.Hash) (*wire.MsgBlock, *btcjson.GetBlockHeaderVerboseResult, error) {
	p.Lock()
...
func (p *BlockPrefetchClient) GetBlockHeaderVerbose(hash *chainhash.Hash) (*btcjson.GetBlockHeaderVerboseResult, error) {
...
// becomes "current".
func (p *BlockPrefetchClient) storeNext(msgBlock *wire.MsgBlock, headerResult *btcjson.GetBlockHeaderVerboseResult) {
	p.current = p.next
	p.next = &blockData{
...
func (p *BlockPrefetchClient) retrieveBlockAndHeaderResult(hash *chainhash.Hash) (*wire.MsgBlock, *btcjson.GetBlockHeaderVerboseResult, error) {
